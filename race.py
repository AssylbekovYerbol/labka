...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("./assets2/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        super().__init__()
        self.image = pygame.image.load("./assets2/coin.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("./assets2/Player.png")
        self.rect = self.image.get_rect()
...
background = pygame.image.load("./assets2/AnimatedStreet.png")
